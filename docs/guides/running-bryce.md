...
exact nineteen tools) → `status` → `digest_preview` (read-only — sends nothing, writes nothing), then
...
- **[MCP Reference](../mcp/README.md)** — all nineteen tools, their inputs and result shapes, and how
