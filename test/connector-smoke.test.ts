...
describe("connector smoke", () => {
  ...
  it("happy path: exact 25 tools, healthy status, read-only preview, no-bearer 401 — no mail, no write", async () => {
    ...
    expect(out).toContain("PASS tools/list - all 25 tools present");
